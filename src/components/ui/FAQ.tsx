          ...
          <div key={i}>
            <h3 className="m-0">
              <button
                ...
                onClick={() => toggle(i)}
                className="flex w-full items-center justify-between gap-4 py-5 text-left text-body-lg font-medium text-text transition-colors duration-[var(--dur-fast)] hover:text-accent focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent-green"
              >
